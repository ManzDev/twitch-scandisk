...
export default class ScandiskScreenSurface extends LitElement {
  ...
  finish() {
    ...
    const event = new CustomEvent("SCANDISK_SUMMARY_START", {
      detail: { value: this.failedBlocks },
      composed: true,
    });
...
customElements.define("scandisk-screen-surface", ScandiskScreenSurface);
